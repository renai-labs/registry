...
Runs through the verification checklist:
  1. server reachable (/system_stats)
  2. at least one checkpoint installed
  3. (optional) a specific workflow's deps are met
  4. (optional) actually submit a tiny test workflow and verify round-trip
