...
Scoping follows the Ren standard — see [[ren-scope]]. Your **private pod** lives in your user namespace; every pod command needs `--scope user` when targeting it.
...
```
mcp__ren__pod_list             { "query": { "scope": "user" } }
