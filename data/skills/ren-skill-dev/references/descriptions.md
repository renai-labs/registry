...
- **Cover both halves** — _what it does_ AND _when to trigger_. Weak descriptions omit the trigger.
...
More _specific_ about what it does, _broader_ about when it applies.

## Sanity-check

Jot a few prompts it _should_ fire on (vary phrasing/explicitness) and a few near-misses it
_shouldn't_. If a should-fire reads like it wouldn't match, it's too narrow; if a near-miss
