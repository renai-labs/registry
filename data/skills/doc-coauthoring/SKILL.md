...
Explain that this approach helps ensure the doc works well when others read it (including when they paste it into a fresh agent). Ask if they want to try this workflow or prefer to work freeform.
...
**If no integrations are detected and in a hosted chat app:** Suggest they can enable connectors in the app's connector settings to allow pulling context from messaging apps and document storage directly.
...
**If access to sub-agents is available (e.g., a sub-agent-capable runtime):**
...
**If no access to sub-agents (e.g., a chat-only interface):**

The user will need to do the testing manually.

### Step 1: Predict Reader Questions

Ask what questions people might ask when trying to discover this document. What would they would ask a fresh agent?
